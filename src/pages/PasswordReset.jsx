  ...
  return (
    <div className="reset">
        ...
        <h1>{t("reset_your_password")}</h1>
            ...
            <Button onClick={()=>resetPassword.mutate(passwords.newPassword)} disabled={!passwords.newPassword||!passwords.repeatPassword||passwords.newPassword!==passwords.repeatPassword} className='w-100'>{t("reset")}</Button>
        </Form>
        <ToastContainer/>
    </div>
  )
