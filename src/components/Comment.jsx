  ...
  return (
    <div className='comment'>
      ...
      <p>{comment?.comment}</p>
          ...
          {currentUser&&currentUser.id===comment.user.id && <Button onClick={()=>setIsEditMode(true)} variant="link">{t("edit")}</Button> }
          </div>
          )}
        </div>):(
          <InputGroup>
        ...
        {currentUser&&currentUser.id===comment.userId && (<div className="more">
        <Dropdown>
