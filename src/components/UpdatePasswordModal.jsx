...
const UpdatePasswordModal = ({show,close}) => {
  ...
  <Modal show={show} onHide={close}>
    ...
    <Modal.Footer>
      <Button disabled={!passwords.oldPassword||!passwords.newPassword||!passwords.repeatPassword||(passwords.newPassword!==passwords.repeatPassword)} onClick={()=>updateMutation.mutate({oldPassword:passwords.oldPassword,newPassword:passwords.newPassword})} type="submit" variant="success">{t("update")}</Button>
